            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bventaed table-striped table-bordered table-hover" id="productos_table">
                        ...
                        <tbody>
                        @foreach (old('productos', $venta->productos->count() ? $venta->productos : ['']) as $venta_producto)
                                    ...
                                    <select name="productos[]" class="form-control">
                                        ...
                                        @foreach ($productos_all as $producto)
                                            <option value="{{ $producto->id }}"
                                                @if (old('productos.' . $loop->parent->index, optional($venta_producto)->id) == $producto->id) selected @endif
                        ...
                        @endforeach
                        <tr id="producto{{ count(old('productos', $venta->productos->count() ? $venta->productos : [''])) }}"></tr>
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function(){
      let row_number = {{ count(old('productos', $venta->productos->count() ? $venta->productos : [''])) }};
